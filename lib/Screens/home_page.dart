...
import 'package:firebase_project/groupchat/group_chat_screen.dart';
...
class _HomePageState extends State<HomePage> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(title:Text("Welcome:${_auth.currentUser!.displayName!}" ) ,actions: [
          IconButton(
              onPressed: () {
                logOut(context);
              },
                      ...
                      ? ListTile(
                          onTap: (() {
                            String roomId = chatRoomId(
                                ...
                                userMap![
                                    'name']); //i am using uid instead of display name
